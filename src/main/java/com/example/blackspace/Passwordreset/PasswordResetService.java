...
public class PasswordResetService {
    ...
    private void sendPasswordResetConfirmation(User user) {
        String html = buildBrandedEmail(
            ...
            "<p style='font-size:16px;color:#333;'>Hello <strong>" + user.getFirstName() + "</strong>,</p>"
            + "<p style='color:#333;'>Your password for <strong>BlackSpace Online Store</strong> has been successfully changed.</p>"
            + "<div style='background:#f0fff0;border-left:4px solid #198754;padding:12px 16px;border-radius:6px;margin:16px 0;'>"
            + "<p style='margin:0;color:#198754;font-weight:600;font-size:14px;'>Password updated successfully</p>"
            + "</div>"
            + "<p style='color:#666;font-size:14px;'>If you did <strong>NOT</strong> perform this action, please contact our support team immediately.</p>"
            + "<p style='color:#999;font-size:13px;'>Email: blackspaceonlinestore9@gmail.com</p>"
        );
